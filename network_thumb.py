...
def network_thumb_main(form, con=None):
    ...
    wrapped = wrapped.replace('<link rel="canonical" href="https://coptic-dictionary.org/" />','<link rel="canonical" href="https://coptic-dictionary.org/network_thumb.py" />')
    if tla != "--":
...
if __name__ == "__main__":
    ...
    wrapped = network_thumb_main(form, con)
