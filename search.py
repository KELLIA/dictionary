...
def search_main():
	search_page = """
	    <form id="search" action="results.py" method="GET" accept-charset="UTF-8">
		<table>
		<tr>
		<td>
	        Coptic Word: </td><td><input type="text" name="coptic" id="coptic" class="keyboardInput" lang="cop">
	        <a href="https://www.evertype.com/fonts/coptic/" style="font-size:8pt">(install Coptic keyboard)</a></td></tr>
		<tr>
	        <td>Dialect:</td>
	...
	nlp_service_link = """<div class="bs-component" style="width: 340px;border: 1px solid black;background-color: rgba(252, 244, 181, 0.5);padding: 12px;margin-left: 4px;margin-top: 4px;font-size: smaller;">Need help segmenting Coptic text?<br>Try the <a href="https://tools.copticscriptorium.org/coptic-nlp/">Coptic NLP service</a></div>"""
	wrapped = wrapped.replace("<footer", nlp_service_link + "<footer")
